...
public class CHumanNpc extends EntityPlayer {
    ...
    public CHumanNpc(MinecraftServer minecraftserver, World world, String s, ItemInWorldManager iteminworldmanager) {
        ...
        NetHandler fakea = new Fakeneta();
        NetworkManager netMgr = new NpcNetworkManager(new NpcSocket(), "npc mgr", fakea);
        this.netServerHandler = new NpcNetHandler(minecraftserver, this, netMgr); // this.a
