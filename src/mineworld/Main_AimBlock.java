...
public class Main_AimBlock {
     ...
     */
    public Main_AimBlock(Player player)
    {
     ...
     */
    public Main_AimBlock(Location loc)
    {
     ...
     */
    public Main_AimBlock(Player player, int maxDistance, double checkDistance)
    {
     ...
     * @param checkDistance How often to check for blocks, the smaller the more precise
     */
    public Main_AimBlock(Location loc, int maxDistance, double checkDistance) {
     ...
     */
    public Main_AimBlock (Player player, int maxDistance, double checkDistance, int[] blocksToIgnore)
    {
     ...
     * @param blocksToIgnore Array of what block ids to ignore while checking for viable targets
     */
    public Main_AimBlock (Location loc, int maxDistance, double checkDistance, int[] blocksToIgnore)
    {
     ...
     * @param blocksToIgnore Array of what block ids to ignore while checking for viable targets
     */
    public Main_AimBlock (Player player, int maxDistance, double checkDistance, ArrayList<String> blocksToIgnore)
    {
     ...
     * @param blocksToIgnore Array of what block ids to ignore while checking for viable targets
     */
    public Main_AimBlock (Location loc, int maxDistance, double checkDistance, ArrayList<String> blocksToIgnore)
    {
    	int[] bti = this.convertStringArraytoIntArray(blocksToIgnore);
